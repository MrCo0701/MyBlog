...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is WritingState);
}
...
/// @nodoc
class $WritingStateCopyWith<$Res>  {
$WritingStateCopyWith(WritingState _, $Res Function(WritingState) __);
}


/// Adds pattern-matching-related methods to [WritingState].
extension WritingStatePatterns on WritingState {
...
class _Initial implements WritingState {
  const _Initial();
...
class _Loading implements WritingState {
  const _Loading();
...
class _Success implements WritingState {
  const _Success();
...
class _Error implements WritingState {
...
@override
String toString() {
  return 'WritingState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $WritingStateCopyWith<$Res> {
