...
mixin _$UserInfoModel {
 ...
 String get id; String get email; String get fullName; String? get avatarUrl; UserStatsModel get stats;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,email,fullName,avatarUrl,stats);

@override
String toString() {
  return 'UserInfoModel(id: $id, email: $email, fullName: $fullName, avatarUrl: $avatarUrl, stats: $stats)';
}
...
@useResult
$Res call({
 String id, String email, String fullName, String? avatarUrl, UserStatsModel stats
});
...
/// Create a copy of UserInfoModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? email = null,Object? fullName = null,Object? avatarUrl = freezed,Object? stats = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String email,  String fullName,  String? avatarUrl,  UserStatsModel stats)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserInfoModel() when $default != null:
return $default(_that.id,_that.email,_that.fullName,_that.avatarUrl,_that.stats);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String email,  String fullName,  String? avatarUrl,  UserStatsModel stats)  $default,) {final _that = this;
switch (_that) {
case _UserInfoModel():
return $default(_that.id,_that.email,_that.fullName,_that.avatarUrl,_that.stats);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String email,  String fullName,  String? avatarUrl,  UserStatsModel stats)?  $default,) {final _that = this;
switch (_that) {
case _UserInfoModel() when $default != null:
return $default(_that.id,_that.email,_that.fullName,_that.avatarUrl,_that.stats);case _:
  return null;
...
class _UserInfoModel implements UserInfoModel {
  const _UserInfoModel({required this.id, required this.email, required this.fullName, this.avatarUrl, required this.stats});
...
@override final  UserStatsModel stats;
...
/// Create a copy of UserInfoModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? email = null,Object? fullName = null,Object? avatarUrl = freezed,Object? stats = null,}) {
